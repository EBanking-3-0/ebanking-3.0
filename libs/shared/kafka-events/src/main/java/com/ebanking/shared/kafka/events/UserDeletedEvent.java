...
/**
 * Event published when a user is deleted (soft or hard delete). Published by: User Service Consumed
 * by: Notification Service, Account Service, Analytics Service, Audit Service
 */
@Data
@SuperBuilder
