...
/**
 * Event published when a cryptocurrency trade is executed.
 * Published by: Crypto Service
...
public class CryptoTradeExecutedEvent extends BaseEvent {
    ...
    public CryptoTradeExecutedEvent(Long tradeId, Long userId, Long accountId,
                                   String cryptoCurrency, String tradeType,
                                   BigDecimal cryptoAmount, BigDecimal fiatAmount,
                                   String fiatCurrency, BigDecimal exchangeRate,
                                   String status) {
        super(KafkaTopics.CRYPTO_TRADE_EXECUTED);
