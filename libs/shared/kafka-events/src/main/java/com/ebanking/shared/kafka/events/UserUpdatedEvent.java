 ...
 * Consumed by: Analytics Service, Audit Service
 */
@Data
@SuperBuilder
...
public class UserUpdatedEvent extends BaseEvent {
    ...
    public UserUpdatedEvent(Long userId, String email, String firstName, 
                           String lastName, String status, String updatedFields) {
        super(KafkaTopics.USER_UPDATED);
        this.userId = userId;
        this.email = email;
