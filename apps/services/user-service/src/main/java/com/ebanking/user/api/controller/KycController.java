...
public class KycController {
  ...
  /**
   * Soumettre une vérification KYC avec upload de fichiers Le corps de la requête est
   * multipart/form-data : - "data" : JSON contenant les informations textuelles (KycRequest) -
   * "cinImage" : fichier image de la CIN - "selfieImage" : fichier selfie
   */
  ...
  public ResponseEntity<KycResponse> submitKyc(
    ...
    try {
      KycVerification kycVerification =
          userService.submitKycWithUserCreation(authentication, kycRequest, cinImage, selfieImage);
