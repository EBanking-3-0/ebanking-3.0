...
public class UserService {
    ...
    public String getFirstNameFromJwt(Authentication authentication) {
        Jwt jwt = (Jwt) authentication.getPrincipal();
        return jwt.getClaim("given_name") != null ? jwt.getClaim("given_name") : jwt.getClaim("firstName");
    }

    public String getLastNameFromJwt(Authentication authentication) {
        Jwt jwt = (Jwt) authentication.getPrincipal();
        return jwt.getClaim("family_name") != null ? jwt.getClaim("family_name") : jwt.getClaim("lastName");
    }
    ...
    public KycVerification submitKycWithUserCreation(
            ...
            MultipartFile selfieImage) throws Exception {
        ...
        User user = userRepository.findByKeycloakId(keycloakId)
                .orElseGet(() -> User.builder()
                        ...
                        .firstName(getFirstNameFromJwt(authentication) != null ? getFirstNameFromJwt(authentication) : "")
                        .lastName(getLastNameFromJwt(authentication) != null ? getLastNameFromJwt(authentication) : "")
                        .phone("")
