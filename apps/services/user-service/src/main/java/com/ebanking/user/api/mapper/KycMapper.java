 ...
 *
 * <p>Responsabilités: - Convertir KycVerification (entité domaine) vers KycResponse (DTO API) -
 * Transformer l'énumération de statut KYC en String
 *
 * <p>MapStruct génère l'implémentation automatiquement au moment de la compilation.
 */
...
public interface KycMapper {
   ...
   *
   * <p>Mappages: - status: Convertir l'énumération KycStatus en String (PENDING_REVIEW, VERIFIED,
   * REJECTED, etc.) - Les autres champs sont mappés par matching de nom
   *
