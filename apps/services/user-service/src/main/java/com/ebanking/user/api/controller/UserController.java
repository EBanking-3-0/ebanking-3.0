 ...
 *
 * Endpoints :
 * - GET /api/v1/users/me : Récupérer le profil de l'utilisateur actuel
 * - GET /api/v1/users/{userId} : Récupérer les détails d'un utilisateur (id)
 * - DELETE /api/v1/users/me : Supprimer le compte de l'utilisateur actuel
 *
 * Notes:
 * - L'utilisateur n'est créé que lors de la soumission du KYC
 * - Le statut utilisateur varie entre PENDING_REVIEW, ACTIVE et REJECTED
 */
@RestController
...
public class UserController {
     ...
     * @return 200 OK avec le profil utilisateur
     *         404 Not Found si l'utilisateur n'existe pas (pas encore soumis de KYC)
     */
    @GetMapping("/me")
     ...
     *
     * Accessible uniquement aux administrateurs ou au propriétaire du compte
     *
     * @param userId UUID de l'utilisateur
     * @return 200 OK avec les détails utilisateur
     ...
     *
     * IMPORTANT: Cette opération est irréversible et supprimera tous les données associées
     *
     * @param authentication Authentication Spring Security contenant le JWT Keycloak
     * @return 204 No Content si suppression réussie
     *         404 Not Found si l'utilisateur n'existe pas
     *         403 Forbidden si accès non autorisé
     */
    @DeleteMapping("/me")
