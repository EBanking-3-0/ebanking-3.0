...
class NotificationConsumerTest {
  ...
  void testHandleUserCreated() {
    ...
    // Assert
    verify(preferenceService).initializeDefaultPreferences(1L);
  ...
  void testHandleTransactionCompleted() {
    ...
    when(accountServiceClient.getAccountOwnerId(1L)).thenReturn(1L);
  ...
  void testHandleConsumerError() {
    ...
    doThrow(new RuntimeException("Service error"))
        ...
        .initializeDefaultPreferences(anyLong());
