...
public class NotificationTestController {
    ...
    public ResponseEntity<Notification> sendSimpleNotification(@RequestBody SendNotificationRequest request) {
    ...
    public ResponseEntity<String> sendSimpleEmail(
        ...
        notificationService.sendSimpleEmail(userId, email, subject, content,
    ...
    public ResponseEntity<String> sendSms(
        ...
        notificationService.sendSms(userId, phoneNumber, message,
                Notification.NotificationType.GENERIC);
