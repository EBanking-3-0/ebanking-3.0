...
public class EmailService {
  ...
  /**
   * Send an HTML email Note: If email is disabled, this method returns silently without throwing
   * exception. Parent NotificationService will mark notification as SENT even though nothing was
   * sent. TODO: Consider throwing exception or returning boolean to indicate actual send status.
   */
