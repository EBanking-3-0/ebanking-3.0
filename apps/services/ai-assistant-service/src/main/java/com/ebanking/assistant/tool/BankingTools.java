...
/**
 * Banking tools that can be called by the AI assistant.
 * These tools are automatically discovered by LangChain4j and made available to the LLM.
 * 
 * Note: userId is passed as a ThreadLocal context set by AiService before tool execution.
 */
@Slf4j
@Component
...
public class BankingTools {
    ...
    public String queryBalance(Long accountId) {
        try {
            ...
            Map<String, Object> result = actionExecutorService.executeAction("query_balance", userId, parameters);
    ...
    public String queryTransactions(Long accountId, Integer limit) {
        try {
            ...
            Map<String, Object> result = actionExecutorService.executeAction("query_transactions", userId, parameters);
            return formatResult(result);
        } catch (Exception e) {
    ...
    public String queryAccountInfo(Long accountId) {
        try {
            ...
            Map<String, Object> result = actionExecutorService.executeAction("query_account_info", userId, parameters);
            return formatResult(result);
        } catch (Exception e) {
    ...
    public String queryUserInfo() {
        try {
            ...
            Map<String, Object> parameters = new HashMap<>();
            parameters.put("userId", userId);
            Map<String, Object> result = actionExecutorService.executeAction("query_user_info", userId, parameters);
            return formatResult(result);
        } catch (Exception e) {
    ...
    public String queryCryptoPortfolio() {
        try {
            ...
            Map<String, Object> parameters = new HashMap<>();
            parameters.put("userId", userId);
            Map<String, Object> result = actionExecutorService.executeAction("query_crypto_portfolio", userId, parameters);
            return formatResult(result);
        } catch (Exception e) {
