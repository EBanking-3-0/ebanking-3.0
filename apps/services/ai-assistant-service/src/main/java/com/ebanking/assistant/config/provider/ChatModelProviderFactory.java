...
/**
 * Factory for selecting the appropriate ChatModelProvider. Manages registration and selection of
...
public class ChatModelProviderFactory {
  ...
  public ChatModelProviderFactory(List<ChatModelProvider> providerList) {
    this.providers =
        providerList.stream().collect(Collectors.toMap(ChatModelProvider::getProviderName, p -> p));
