...
/**
 * Google Gemini provider implementation for ChatLanguageModel.
 * Supports Gemini Pro and other Gemini models.
 * NOTE: Gemini dependency (langchain4j-google-ai-gemini) not included in build.gradle.
 * This provider will be unavailable until the dependency is added.
 */
@Slf4j
@Component
public class GeminiChatModelProvider implements ChatModelProvider {
    ...
    public ChatLanguageModel createModel(String apiKey, String model, Double temperature, Integer maxTokens) {
        log.warn("Gemini provider is not available. Please add langchain4j-google-ai-gemini dependency.");
        throw new UnsupportedOperationException("Gemini provider requires langchain4j-google-ai-gemini dependency");
    }
