...
/**
 * Utility class for extracting user information from JWT tokens. In production, use a proper JWT
 * library like jjwt or spring-security-jwt.
 */
@Slf4j
@Component
public class SecurityUtil {
  ...
  /**
   * Extract user ID from JWT token in Authorization header. Extracts the 'sub' claim which contains
   * the user's UUID.
   */
