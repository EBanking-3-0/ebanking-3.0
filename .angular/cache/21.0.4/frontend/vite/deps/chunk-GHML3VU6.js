...
var XSSI_PREFIX$1 = /^\)\]\}',?\n/;
var FETCH_BACKEND = new InjectionToken(
...
var HttpXhrBackend = class _HttpXhrBackend {
  ...
  maybePropagateTrace(fn) {
    return this.tracingService?.propagate
      ? this.tracingService.propagate(fn)
      : fn;
  }
  handle(req) {
    if (req.method === "JSONP") {
...
var XSRF_ENABLED = new InjectionToken(
...
var XSRF_COOKIE_NAME = new InjectionToken(
...
var XSRF_HEADER_NAME = new InjectionToken(
...
var HttpXsrfTokenExtractor = class _HttpXsrfTokenExtractor {
  ...
  static ɵprov = ɵɵdefineInjectable({
    ...
    factory: function HttpXsrfTokenExtractor_Factory(__ngFactoryType__) {
      let __ngConditionalFactory__ = null;
      if (__ngFactoryType__) {
        __ngConditionalFactory__ = new (
          __ngFactoryType__ || _HttpXsrfTokenExtractor
        )();
      } else {
...
var HttpResourceImpl = class extends ResourceImpl {
  ...
  headers = computed(
    () =>
      this.status() === "resolved" || this.status() === "error"
        ? this._headers()
        : void 0,
    ...(ngDevMode
      ? [
...
//# sourceMappingURL=chunk-GHML3VU6.js.map
